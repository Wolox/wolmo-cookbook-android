...
class CoroutinesCancellationsExample {

    private var jobA: Job? = null
    private var jobB: Job? = null
    private var jobC: Job? = null

    val startChildrenCancellation: CoroutinesExamplePresenter.() -> Unit = {
    ...
    val startCooperativeCancellation: CoroutinesExamplePresenter.() -> Unit = {
        launch(Dispatchers.Default) {
