...
import ar.com.wolox.android.cookbook.coroutines.football.modules.CoroutinesRecipeModule
...
@Component(
        ...
        modules = [
            ...
            RxJava2Module::class, TestLoginRecipeModule::class, CoroutinesRecipeModule::class
        ]
)
